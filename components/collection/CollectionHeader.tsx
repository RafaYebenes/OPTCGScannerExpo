      ...
      <View style={styles.headerTopRow}>
        ...
        {!!onGoToDecks && (
          ...
          >
            ...
            <Text style={styles.glassButtonText}>MAZOS</Text>
          </Pressable>
        )}
      </View>
        ...
        >
          <Pressable
            style={[
              ...
              activeRarity === "AA" && styles.rarityChipActive,
            ]}
            onPress={() => setActiveRarity(activeRarity === "AA" ? null : "AA")}
          >
            <Text style={[styles.rarityCount, { color: PALETTE.gold }]}>
              {stats.altArts}
            </Text>
            <Text style={[styles.rarityLabel, { color: PALETTE.gold }]}>
              AA
            </Text>
          </Pressable>
          ...
          {rarityStats.map(([rarity, count]) => (
            <Pressable
              ...
              style={[
                styles.rarityChip,
                activeRarity === rarity && styles.rarityChipActive,
              ]}
              onPress={() =>
...
const styles = StyleSheet.create({
  ...
  // ✅ pill “MAZOS” (mismo estilo que scanner)
  glassButton: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "rgba(0, 21, 37, 0.75)",
    paddingVertical: 8,
